    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/staffs", "/api/staffs/**").hasRole("ADMIN")
                        .requestMatchers("/api/cart/**", "/api/cart").permitAll()
                        .requestMatchers("/api/order/place").hasRole("USER")
                        ...
                        .requestMatchers("/api/khuyenmai", "api/khuyenmai/**").hasRole("ADMIN")
